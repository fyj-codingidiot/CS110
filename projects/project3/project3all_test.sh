...
# Usage: run with 
# -  'zsh xxx.sh 1' to check speed without checking accuracy
# -  'zsh xxx.sh 2' to check speed along with accuracy

# Remember to change the file name "test2.jpg", "test3.jpg"
# if you want to use your custom test images
...
test_without_accuracy () {
    ...
    echo "\033[37;44m Original Test \033[0m "
    input_img='test.jpg'
    counter=1
    ...
    echo "\033[37;44m Custom Test 2 \033[0m "
    input_img='ubt.jpg'
    counter=1
    run_fast $input_img 0.6 -2.0 2.0 79 79
    run_fast $input_img 0.2 -4.0 4.0 421 411
    ...
    echo "\033[37;44m Custom Test 3 \033[0m "
    input_img='big.jpg'
    counter=1
    run_fast $input_img 0.6 -2.0 2.0 79 79
    run_fast $input_img 0.2 -4.0 4.0 421 411
